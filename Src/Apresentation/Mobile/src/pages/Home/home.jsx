...
const handleConfirmSignOut = () => {
  ...
  const handleDocumento = () => {
    navigation.navigate("editar_Documento");
  };
  ...
  return (
    ...
    >
        ...
        <Text style={styles.bemvindoText}>O que temos para hoje?</Text>
        ...
        <TouchableOpacity style={styles.caixaopcoesAzul} onPress={(handleProcesso)}>
          ...
          <TouchableOpacity style={styles.caixaopcoesAzul} onPress={(handleDocumento)}>
          <Ionicons name="documents" size={24} color="#fff" />
            <Text style={styles.opcoesText4}>Editar documento</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.caixaopcoesCinza} onPress={handleConfirmSignOut}>
