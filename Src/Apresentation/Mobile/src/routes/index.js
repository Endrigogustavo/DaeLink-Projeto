...
import Visualizar_Documento from "../pages/Vaga/visualizar_Documento";
...
import Documentos from "../pages/Vaga/enviar_Documentos";
import Editar_Documento from "../pages/Vaga/editar_documento";
import EntrarVaga from "../pages/Vaga/entrar_vaga";
