                ...
                <div className="bg-gray-900 w-4/6 h-5/6 rounded-64px flex aboutextcontainer">
                    <div className="content w-full h-full flex flex-col items-center  gap-16 py-20">
                        <div className="flex flex-col items-center ">
                            ...
                            <p className="text-justify px-20 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt voluptatem nulla quam ex quidem maxime nemo beatae libero! Quisquam unde ea earum, cumque fugit in!</p>
                        </div>
