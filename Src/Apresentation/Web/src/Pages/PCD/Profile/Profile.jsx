...
function Profile() {
    ...
    return (
        <>
            <div className='h-80 w-full profilebackground'>
                <img src={userProfile.imageProfile} className="w-full h-full rounded-tl-lg rounded-tr-lg object-cover" />
            </div>
            <div className='h-fit w-full flex px-8'>
                <div className='w-2/6 h-fit flex flex-col items-center relative transform -translate-y-24 gap-2'>
                ...
                <div className='w-4/6 h-fit flex flex-col items-center pl-8'>
                    ...
                    <div className={`w-full h-fit flex  py-2 gap-1`}>
                        {tab === 1 && (
                            <>
                                <div className='w-fit h-fit rounded-3xl shadow-2xl border-2 border-gray-300 p-4 gap-2 mr-4'>
                                ...
                                <div className='w-72 h-fit rounded-3xl shadow-2xl border-2 border-gray-300 p-4 gap-2 mr-4'>
                                    <div className='flex w-full justify-center gap-1'>
                            ...
                            <>
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <div className='flex gap-2'>
                                        <button className=" w-40 bg-transparent hover:bg-gray-200 font-bold 
