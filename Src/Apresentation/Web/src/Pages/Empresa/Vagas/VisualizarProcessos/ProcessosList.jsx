...
function ProcessosList() {
    ...
    return (
        <>
            ...
            <div className={`w-full h-fit flex justify-center items-center flex-col py-4 ${vagas.length > 0 ? 'grid ProcessosEmpresas gap-4 gap-y-12 justify-items-center items-center pb-8' : ''}`}>
                {vagas.map((vaga) => (
